...
void Vertex::create_lua_bind(sol::state& lua) {
    ...
    lua.set("J2D_RED", Color{255, 255, 255, 255});
    lua.set("J2D_GREEN", Color{255, 255, 255, 255});
    lua.set("J2D_BLUE", Color{255, 255, 255, 255});
    lua.set("J2D_BLACK", Color{255, 255, 255, 255});
    lua.set("J2D_YELLOW", Color{255, 255, 255, 255});
    lua.set("J2D_MAGENTA", Color{255, 255, 255, 255});
}
